...
const NEWS = [
  ...
  {id:"n21", e:"🥚", t:"ヤミノオウのタマゴ 登場！", b:"バトルで「ヤミノオウ」を倒すと、まれに🥚タマゴをドロップ！「記録」タブからお世話して育てると、幼年期1→幼年期2→成長期→成熟期→完全体→究極体（じぶんだけの👑ヤミノオウ）と6段階に進化するよ。段階が上がるたびに しんか演出！育てきると「ひみつのなかま」で すがたにできる。毎日コツコツお世話するのがポイント！"},
