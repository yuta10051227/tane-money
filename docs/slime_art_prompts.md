...
## 4. 最終形態(人型)＝オリジナル魔人プロンプト（srimu5 用）

> ねらい：青スライムが「人の姿」もとれる魔人へ。**特定キャラの色違いにならないよう**、構図・髪型・瞳・装飾・マントのモチーフを最初から別物にしています。下の **必須ネガティブ** を必ず付けてください（既存キャラの記号を避けるため）。

**必須ネガティブ（このセクション専用・上の共通ネガティブに追加）**
```
no gold/yellow eyes, no blue diamond gem on chest, not holding a slime in hand,
no water-dripping cape hem, no light-blue bob haircut, avoid resembling any existing anime character
```

### 案A：芽吹きの魔人（タネ／自然モチーフ＝アプリ世界観に直結）★おすすめ
```
[STYLE BIBLE without the "slime material" line] +
original chibi humanoid magic-being, slime-born spirit with smooth pale-blue skin,
short tousled teal-green hair, calm round teal eyes, gentle confident smile,
wearing a cream-and-leaf-green explorer cloak with a small wooden leaf clasp,
the cloak hem shaped like overlapping leaves, a tiny sprout floating above one hand,
holding a short staff topped with a glowing green seed, standing upright and friendly,
full body, front view, transparent background
```
JP：青みのある肌のチビ魔人。**短めの青緑ヘア・丸い緑の瞳**。クリーム×葉緑の探検マント（裾は葉っぱ形・木の葉の留め具）。片手に小さな芽、手には**芽吹くタネの杖**。胸の宝石なし・スライムを持たない・水滴マントなし。

### 案B：星詠みの魔人（夜空／星モチーフ）
```
[STYLE BIBLE without the "slime material" line] +
original chibi humanoid magic-being with pale-blue skin, soft silver-white side-braid hair,
round violet eyes, serene smile, wearing a deep-indigo starry poncho with a crescent-moon
brooch and a wide soft hood, small orbiting star sparkles, holding a rounded star-tipped wand,
arms relaxed at sides, full body, front view, transparent background
```
JP：青み肌のチビ魔人。**銀白のサイド三つ編み・紫の瞳**。藍色の星柄ポンチョ＋**三日月のブローチ**・深いフード。星のステッキ。胸の青ひし形なし・スライム非保持・水滴裾なし。

**枚数・書き出し**：他段階と同じ。`monster_srimu5_f0〜3.png`（＋`_side_f0,f1`）、320×320透過PNG。フルボディ（人型）なので、足元を下そろえ・全身が枠に収まるように。

> どちらの案も「青スライムが姿を変えた魔人」という流れは保ちつつ、既存キャラとは別デザインです。気に入った案で4コマ作ってくれれば `srimu5` に取り込みます。
