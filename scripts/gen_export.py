...
import gen_legend, gen_metal, gen_paladin, gen_more, gen_gline

# id -> (描画関数, 論理サイズ)
SPRITES = {
    "ogon":   (gen_legend.draw,        48),   # オウゴンリュウ(隠しスキン)
    ...
    # g系統「金竜ライン」進化ツリー
    "sumi":      (gen_gline.m_sumi,      40),
    "futaba":    (gen_gline.m_futaba,    40),
    "koryu":     (gen_gline.m_koryu,     40),
    "grandrago": (gen_gline.m_grandrago, 40),
    "soraryu":   (gen_gline.m_soraryu,   40),
}
FACTOR = 4   # 論理px -> 出力px
